...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="DEEPAK" width="400" height="300">
        <p><strong>DEEPAK</strong></p>
        <p> 3rd year DTU COE</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic.jpg" alt="DHRUV" width="400" height="300">
        <p><strong>DHRUV</strong></p>
        <p>3rd year DTU COE</p>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 7701917238 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> deepakkumardk2811@gmail.com</p>
    </div>
